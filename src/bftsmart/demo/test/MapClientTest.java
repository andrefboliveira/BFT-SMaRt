...
public class MapClientTest<K, V> implements Map<K, V> {

	ServiceProxy serviceProxy;

	public MapClientTest(int clientId) {
	...
	public V put(K key, V value) {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
			...
			objOut.writeObject(MapRequestTypeTest.PUT);
	...
	public V get(Object key) {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
			...
			objOut.writeObject(MapRequestTypeTest.GET);
			objOut.writeObject(key);
	...
	public V remove(Object key) {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
			...
			objOut.writeObject(MapRequestTypeTest.REMOVE);
			objOut.writeObject(key);
	...
	public int size() {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
		     ObjectOutput objOut = new ObjectOutputStream(byteOut);) {
			objOut.writeObject(MapRequestTypeTest.SIZE);
			objOut.flush();
			byteOut.flush();
	...
	public Set<K> keySet() {
		try (ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
			...
			objOut.writeObject(MapRequestTypeTest.KEYSET);
