...
public class JoinThread implements Runnable {
	...
	public JoinThread(int id, TOMConfiguration configuration, View currentView) {
		this.id = id;
...
//					addReplica(configuration, currentView, replicaReply.getReplicaCertificates());
	...
	private void addReplica(TOMConfiguration configuration, View currentView, List<PartialCertificate> replicaCertificates) {
...
//                            int newPort = sc.nextInt();
		...
		reconfigServices.addServer(this.id, newIP, newPort, replicaCertificates, configuration);
	}
